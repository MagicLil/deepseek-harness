...
export const en: Record<AgentPresetSettingsKey, string> = {
  title: 'Agent preset',
  description: 'Applies to every existing session across all projects, and to sessions you start from now on. Changing the preset in a session header affects only that session.',
  loading: 'Loading presets…',
  error: 'Could not load agent presets.',
  userTrust: 'Custom',
  seatHint: 'Agent preset for the session you are about to start',
  headerHint: 'Agent preset for this session. Changing it here affects only this session.',
  nav: 'Agent presets',
  sectionIntro:
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  title: 'Agent 预设',
  description: '对所有项目里已有的会话生效，也对之后新建的会话生效。在会话标题旁更改则只影响当前会话。',
  loading: '正在加载预设…',
  error: '无法加载 Agent 预设。',
  userTrust: '自定义',
  seatHint: '即将开始的这个会话所用的 Agent 预设',
  headerHint: '本会话的 Agent 预设。在这里更改只影响当前会话。',
  nav: 'Agent 预设',
