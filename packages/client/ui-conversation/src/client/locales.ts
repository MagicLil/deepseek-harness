...
export const zh = {
  ...
  'hero.headline': '打造数字化全流程',
  'hero.preview': '预览版',
  'hero.chooseWorkspace': '选择工作区',
  'hero.workspaceFailed': '无法打开工作区：{message}',
  ...
  'tool.error.default': '操作未完成，请稍后重试。',
  'tool.error.fileBusy': '操作未完成，请稍后重试。目标文件可能正在被其他程序占用。',
  'tool.error.permission': '没有权限执行该操作。',
  'tool.error.notFound': '目标不存在或已被移动。',
  'tool.error.stale': '目标文件已被其他程序修改，请重新读取后再试。',
  'tool.error.developerMode': '开发者模式',
  'tool.error.debugDetails': '调试详情',
...
export const en = {
  ...
  'hero.workspaceFailed': 'Couldn’t open workspace: {message}',
  ...
  'clock.md': '{m}/{d}',
  'clock.ymd': '{y}-{m}-{d}',
  'tool.error.default': 'The operation did not complete. Please try again later.',
  'tool.error.fileBusy': 'The operation did not complete. Please try again later. The target file may be in use by another program.',
  'tool.error.permission': 'You do not have permission to perform this operation.',
  'tool.error.notFound': 'The target does not exist or has been moved.',
  'tool.error.stale': 'The target file was modified by another program. Re-read it and try again.',
  'tool.error.developerMode': 'Developer mode',
  'tool.error.debugDetails': 'Debug details',
