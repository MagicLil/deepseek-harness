...
import {
  ...
  hostGitBranchesRequestSchema, hostGitCheckoutRequestSchema,
  ...
  hostGitSuggestCommitRequestSchema,
  hostGitSyncRequestSchema, hostGitUnstageRequestSchema,
  hostTerminalKillRequestSchema, hostTerminalListRequestSchema,
  hostTerminalOpenRequestSchema, hostTerminalReadRequestSchema,
  hostTerminalResizeRequestSchema, hostTerminalSendRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.gitSync': { schema: hostGitSyncRequestSchema, invoke: (api, r, signal) => api.host.gitSync(r, signal) },
  'host.gitBranches': { schema: hostGitBranchesRequestSchema, invoke: (api, r, signal) => api.host.gitBranches(r, signal) },
  'host.gitCheckout': { schema: hostGitCheckoutRequestSchema, invoke: (api, r, signal) => api.host.gitCheckout(r, signal) },
  'host.gitSuggestCommit': { schema: hostGitSuggestCommitRequestSchema, invoke: (api, r, signal) => api.host.gitSuggestCommit(r, signal) },
  'host.terminalList': { schema: hostTerminalListRequestSchema, invoke: (api, r) => api.host.terminalList(r) },
  'host.terminalOpen': { schema: hostTerminalOpenRequestSchema, invoke: (api, r, signal) => api.host.terminalOpen(r, signal) },
  'host.terminalSend': { schema: hostTerminalSendRequestSchema, invoke: (api, r, signal) => api.host.terminalSend(r, signal) },
  'host.terminalWrite': { schema: hostTerminalWriteRequestSchema, invoke: (api, r) => api.host.terminalWrite(r) },
  'host.terminalResize': { schema: hostTerminalResizeRequestSchema, invoke: (api, r) => api.host.terminalResize(r) },
  'host.terminalRead': { schema: hostTerminalReadRequestSchema, invoke: (api, r) => api.host.terminalRead(r) },
  'host.terminalSignal': { schema: hostTerminalSignalRequestSchema, invoke: (api, r) => api.host.terminalSignal(r) },
  'host.terminalKill': { schema: hostTerminalKillRequestSchema, invoke: (api, r) => api.host.terminalKill(r) },
