...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('file-too-large'), message: z.string(), details: z.object({ path: z.string(), size: z.number(), maxBytes: z.number() }) }),
  z.object({ code: z.literal('file-binary'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-write-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-exists'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-rename-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-delete-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('git-unavailable'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('git-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('search-unavailable'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('search-invalid'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('search-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
