...
export interface RpcMethodMap {
  ...
  'host.readFileBytes': HostApi['readFileBytes']
  'host.writeFile': HostApi['writeFile']
  'host.renameEntry': HostApi['renameEntry']
  'host.deleteEntry': HostApi['deleteEntry']
  'host.search': HostApi['search']
  'host.gitStatus': HostApi['gitStatus']
  'host.gitDiff': HostApi['gitDiff']
  'host.gitStage': HostApi['gitStage']
  'host.gitUnstage': HostApi['gitUnstage']
  'host.gitCommit': HostApi['gitCommit']
  'host.gitDiscard': HostApi['gitDiscard']
  'host.gitLog': HostApi['gitLog']
  'host.gitSync': HostApi['gitSync']
  'host.gitBranches': HostApi['gitBranches']
  'host.gitCheckout': HostApi['gitCheckout']
  'host.gitSuggestCommit': HostApi['gitSuggestCommit']
  'host.terminalList': HostApi['terminalList']
  'host.terminalOpen': HostApi['terminalOpen']
  'host.terminalSend': HostApi['terminalSend']
  'host.terminalWrite': HostApi['terminalWrite']
  'host.terminalResize': HostApi['terminalResize']
  'host.terminalRead': HostApi['terminalRead']
  'host.terminalSignal': HostApi['terminalSignal']
  'host.terminalKill': HostApi['terminalKill']
