...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    occupants: [
      'client-ui-xmart-workbench ActivityBar',
    ],
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-xmart-workbench BottomPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-xmart-workbench ReviewDock id \'agent-review-dock\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-editor CodeEditorView id \'editor\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Tool-details column between conversation and the session sidebar, shown when the layout opens it.',
    doc: 'Tool-details column between conversation and the session sidebar,\nshown when the layout opens it. OCCUPIED by ui-conversation\'s\nDetailsPanel. Absent an occupant the column renders nothing.\n\nNo owner props: the framework injects the session id and hooks for the\n`session` scope, and `ctx.layout` owns whether the column is open.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-xmart-workbench MenuBar',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-xmart-workbench PrimarySidebar',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-xmart-lan LanSettingsSection id \'lan\'',
      'client-ui-xmart-skills SkillsSettingsSection id \'skills\'',
      'client-ui-xmart-workbench WorkbenchSettingsSection id \'workbench\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-xmart-workbench WorkbenchColumn',
    ],
    replaceRisk: 'shadows-shipped-ui',
