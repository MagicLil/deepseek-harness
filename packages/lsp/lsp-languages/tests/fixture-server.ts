/**
 * Fake language server over stdio for lsp-languages tests.
 * Env:
...
function handle(message: { id?: number; method?: string; params?: unknown; result?: unknown; error?: unknown }): void {
  ...
  if (method === 'textDocument/didOpen') {
    if (openMarker !== undefined) {
      const params = message.params as { textDocument?: { text?: unknown; languageId?: unknown } } | undefined
      appendFileSync(openMarker, `${JSON.stringify(params?.textDocument)}\n`)
    }
