 ...
 * @module @deepseek-ai/dsh-lsp-languages/connection
 */
...
export interface PersistentConnectionSpec {
...
export class PersistentLspConnection {
  ...
  constructor(
    ...
    if (this.handle.stdin === undefined || this.handle.stdout === undefined) {
      throw new Error('lsp-languages: subprocess implementation dropped a piped protocol stream')
    }
    /* v8 ignore stop */
