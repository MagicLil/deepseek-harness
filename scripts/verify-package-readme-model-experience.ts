...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-xmart-marketplace': { kind: 'none', reason: 'Browser-side marketplace chrome; registers nothing model-facing.' },
  'packages/client/ui-xmart-skills': { kind: 'none', reason: 'Browser-side Skills settings page; registers nothing model-facing.' },
  ...
  'packages/host/marketplace': { kind: 'none', reason: 'Host-side marketplace Remote; registers nothing model-facing.' },
  'packages/host/skill-manager': { kind: 'none', reason: 'Host-side skill file manager Remote; registers nothing model-facing.' },
  ...
  'packages/lsp/lsp-vue': { kind: 'indirect', reason: 'The Vue language-server backend delegates model rendering to dsh-tool-lsp; editor remotes are not model-facing.' },
  'packages/lsp/lsp-languages': { kind: 'indirect', reason: 'The TypeScript and Java language-server backends delegate model rendering to dsh-tool-lsp; editor remotes are not model-facing.' },
